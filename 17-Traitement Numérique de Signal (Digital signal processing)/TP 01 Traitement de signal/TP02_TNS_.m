...
xlabel('Frequences')
ylabel('Amplitude')
title('spectre du signal échantionné par une fréquence de 500Hz')
...
% la fréquence d'échantillonage a un effet direct sur l'autocorelation.
...
plot(l,Cm3)
grid on
title("l'autocorelation pour la fonction sinusoïde modulée par une gaussienne")
...
plot(0:1:length(m4)-1,m4);
grid on
title("Le signal reçu par le radar sans bruit")

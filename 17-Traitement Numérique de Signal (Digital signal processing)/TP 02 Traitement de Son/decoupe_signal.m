...
%x est l'ensemble des valeurs des èantillons
%fe est la fruence d'èantillonnage
...
%signal est une matrice oBèaque ligne correspond aux valeurs 
% d'une trame et chaque colonne un èantillon associ  un 
% moment particulier de la trame
%ech_trames est une matrice oBèaque ligne indique le temps associJ% #haque èantillon de la trame consid©e
